...
function App() {
  ...
  return <div className="app-shell">
    <aside className={mobileOpen ? 'sidebar open' : 'sidebar'}>
      <div className="brand"><span className="brand-mark">G</span><span>GAMLB</span><small>Семейная история</small></div>
...
createRoot(document.getElementById('root')).render(window.location.pathname.startsWith('/admin') ? <AdminAuthGate><AdminApp/></AdminAuthGate> : <App/>);
